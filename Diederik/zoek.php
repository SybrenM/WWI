    ...
    <body>
        ...
        <div class="container">
            <form action="vergelijk.php">
                            ...
                            <a href="artikel.php?artikelid=<?php print($artikelID . "&maatselected=FALSE"); ?>" class="artikelTekst">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        ...
                                        <input type="checkbox" name="vergelijk[]" value="<?php print($artikelID); ?>">Vergelijk <!-- De vergelijk checkbox -->
                                    </div>
                                    <hr style="width:80%">
                                </div>
                            </a>
                ...
                ?>
                <button class="btn btn-primary vergelijk" type="submit">Vergelijk</button><!-- Hier zit de knop vast aan de onderkant van het scherm-->
            </form>
        </div>
