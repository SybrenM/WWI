                    ...
                    <form class="form-inline" action="zoek.php">
                        ...
                        <li class="nav-item">
                            ...
                            if (!isset($_SESSION['email'])) {
                                ?> <!DOCTYPE html> <a class="nav-link" href="LoginMain.php">Login</a> <?php
                            }
                            ?>
                        ...
                        if (isset($_SESSION['email'])) {
                            ?> <!DOCTYPE html> <a class="nav-link" href="logout.php">Logout</a> <?php
                        }
                        ?>
                        <?php
                        //Controleerd of de gebruiker is ingelogd. als dit niet het geval is wordt de Login knop weergeven//
                        if (isset($_SESSION['email'])) {
                            ?> <!DOCTYPE html> <a class="nav-link" href="customerinfo.php">Klantinformatie</a> <?php
                        }
                        ?>
                    </form>
                    </li>
